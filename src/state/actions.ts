import type { Artifact, IssueStatus, PlanningPreferences, ReleasePackage, ReviewIssue, WorkspaceState } from '../domain/models';
...
export type WorkspaceAction =
  ...
  | { type: 'release/publish'; release: ReleasePackage }
