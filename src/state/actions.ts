import type { Artifact, ExportRecord, IssueStatus, PlanningPreferences, ReviewIssue, WorkspaceState } from '../domain/models';
...
export type WorkspaceAction =
  ...
  | { type: 'zone/reorder'; order: string[]; baseSignature: string; at?: string }
  | { type: 'export/record'; record: ExportRecord }
