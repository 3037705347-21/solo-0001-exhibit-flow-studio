import type { Artifact, IssueStatus, PlanApproval, PlanningPreferences, ReviewIssue, WorkspaceState } from '../domain/models';
...
export type WorkspaceAction =
  ...
  | { type: 'project/approve'; approval: PlanApproval }
