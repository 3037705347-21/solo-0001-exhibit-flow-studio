...
export function createSeedWorkspace(): WorkspaceState {
  return {
    ...
    issueHistory: [
      {
        id: 'rev-audio-transcript-1',
        issueId: 'issue-audio-transcript',
        kind: 'create',
        baseVersion: 0,
        resultVersion: 1,
        editor: 'Mara Chen',
        ...
        changes: [
          { field: 'title', before: '', after: 'Add transcript beside oral history station' },
          { field: 'description', before: '', after: 'The current audio treatment needs a synchronized transcript and a printed fallback.' },
          { field: 'severity', before: '', after: 'warning' },
          { field: 'owner', before: '', after: 'Mara Chen' },
          { field: 'zoneId', before: '', after: 'zone-after' },
          { field: 'artifactId', before: '', after: 'artifact-tape' },
        ],
        committedAt: '2026-08-20T10:00:00.000Z',
      },
      {
        id: 'rev-audio-transcript-2',
        issueId: 'issue-audio-transcript',
        kind: 'edit',
        baseVersion: 1,
        resultVersion: 2,
        editor: 'Mara Chen',
        rationale: 'Accessibility review escalated the missing transcript to a launch blocker.',
        changes: [{ field: 'severity', before: 'warning', after: 'critical' }],
        committedAt: '2026-09-01T14:30:00.000Z',
      },
      {
        id: 'rev-entry-copy-1',
        ...
        rationale: 'Finding captured.',
        changes: [
          { field: 'title', before: '', after: 'Reduce entry panel copy' },
          { field: 'description', before: '', after: 'The opening panel currently competes with the lantern sightline and should be shortened.' },
          { field: 'severity', before: '', after: 'warning' },
          { field: 'owner', before: '', after: 'Theo James' },
          { field: 'zoneId', before: '', after: 'zone-arrival' },
          { field: 'artifactId', before: '', after: '' },
        ],
        committedAt: '2026-08-23T12:00:00.000Z',
      },
      {
        id: 'rev-quilt-light-1',
        ...
        rationale: 'Finding captured.',
        changes: [
          { field: 'title', before: '', after: 'Confirm quilt lux rotation' },
          { field: 'description', before: '', after: 'Conservation confirmed the zone level; document the planned three-month rotation.' },
          { field: 'severity', before: '', after: 'note' },
          { field: 'owner', before: '', after: 'Rina Solberg' },
          { field: 'zoneId', before: '', after: 'zone-common' },
          { field: 'artifactId', before: '', after: 'artifact-quilt' },
        ],
