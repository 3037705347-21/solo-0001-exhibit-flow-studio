import { BookOpen, Boxes, ChevronRight, CircleHelp, Compass, FlaskConical, Gauge, LayoutDashboard, RotateCcw, Settings2, Sparkles, SunMedium } from 'lucide-react';
...
const navigation = [
  ...
  { to: '/sandbox', label: 'Capacity sandbox', icon: FlaskConical, detail: 'Trial changes' },
