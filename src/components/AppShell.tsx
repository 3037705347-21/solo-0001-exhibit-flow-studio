import { BookOpen, Boxes, ChevronRight, CircleHelp, Compass, FileArchive, Gauge, LayoutDashboard, RotateCcw, Settings2, Sparkles, SunMedium } from 'lucide-react';
...
const navigation = [
  ...
  { to: '/archive', label: 'Plan archive', icon: FileArchive, detail: 'Imported snapshots' },
];
