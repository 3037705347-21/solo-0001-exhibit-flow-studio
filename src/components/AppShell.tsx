import { BookOpen, Boxes, ChevronRight, CircleHelp, Compass, Gauge, LayoutDashboard, Layers, RotateCcw, Settings2, Sparkles, SunMedium } from 'lucide-react';
...
const navigation = [
  ...
  { to: '/zones', label: 'Exhibition zones', icon: Layers, detail: 'Rooms & capacity' },
